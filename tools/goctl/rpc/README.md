...
Flags:
  ...
  -m, --multiple          Generated in multiple rpc service mode
      --remote string     The remote git repo of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority
                          	The git repo directory must be consistent with the https://github.com/toby1991/go-zero-template directory structure
      --style string      The file naming format, see [https://github.com/toby1991/go-zero/tree/master/tools/goctl/config/readme.md] (default "gozero")
...
## rpc 服务生成 example
详情见 [example/rpc](https://github.com/toby1991/go-zero/tree/master/tools/goctl/example)
